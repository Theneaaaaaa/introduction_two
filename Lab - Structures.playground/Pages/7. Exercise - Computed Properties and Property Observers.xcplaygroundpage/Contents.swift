...
var rectangle = Rectangle(width: 7, height: 8)
...
struct Height {
    var heightInInches: Double {
        didSet {
            if heightInCentimeters != heightInCentimeters {
...
var height = Height(heightInCentimeters: 161)
print(height.heightInInches)
height.heightInCentimeters = 161
print(height.heightInInches)
