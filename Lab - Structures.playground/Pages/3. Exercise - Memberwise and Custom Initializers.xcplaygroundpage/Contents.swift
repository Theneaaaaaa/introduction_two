...
let favoriteBook = Book(title: "Harry Potter", author: "J.K.Roling", pages: 800, price: 80.0)
...
struct Height {
    ...
    init(heightInInches:Double) {
        ...
        self.heightInCentimeters = 2.54 * self.heightInInches
    }
 ...
 */
var myHeight = Height(heightInCentimeters: 161)
